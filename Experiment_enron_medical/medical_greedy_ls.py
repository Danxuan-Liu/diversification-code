...
if __name__ == '__main__':
    ...
    argparser.add_argument('-p', '--save_file', help="save_result", default='medical_Result_Greedy_LS', type=str)
    argparser.add_argument('-n_items', help="number of features", default=1449, type=int)
    argparser.add_argument('-NMI', default='medical/NMI.txt', type=str)
    argparser.add_argument('-dis', default='medical/dis.txt', type=str)
    argparser.add_argument('-constraint', help="max size of subset", default=10, type=int)
    argparser.add_argument('-mylambda', help="trade_off", type=float, default=0.5)
    argparser.add_argument('-top', type=int, default=10)
    argparser.add_argument('-l', help="number of lables", default=45, type=int)

    argparser.add_argument('-dim', default=978, type=int)
    args = argparser.parse_args()
    args.save_file = f'medical_Result_Greedy_LS/{args.mylambda}'
