...
if __name__ == '__main__':
    ...
    argparser.add_argument('-times', default=1, type=int)
    argparser.add_argument('-p', '--save_file', help="save_result", default='medical_Result_PORD', type=str)
    ...
    args.save_file = f'medical_Result_GSEMO/{args.mylambda}'
